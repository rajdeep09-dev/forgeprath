...
const DockNav = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 py-3 rounded-[2rem] flex items-end gap-1 w-[90%] max-w-sm md:w-auto backdrop-blur-xl bg-background/80 border border-border"
      style={{
