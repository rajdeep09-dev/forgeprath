      ...
      <section className="py-24 md:py-32">
        ...
        <Marquee speed={40}>
          {results.map((r) => (
            ...
            >
              <div className="flex">
                <div className="flex-1 aspect-[3/4] bg-muted/30 flex items-center justify-center border-r border-border/50">
                  <div className="text-center">
                    <User size={32} className="mx-auto text-muted-foreground/30 mb-1" />
                    <span className="mono-label">Before</span>
                  </div>
                </div>
                <div className="flex-1 aspect-[3/4] bg-muted/30 flex items-center justify-center">
                  <div className="text-center">
                    <User size={32} className="mx-auto text-muted-foreground/30 mb-1" />
